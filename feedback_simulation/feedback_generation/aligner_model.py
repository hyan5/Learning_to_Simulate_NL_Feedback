...
class BertAlignerModel(torch.nn.Module):
    def __init__(self, hidden_dim=100, use_autoencoder=False, similarity_mode='average', model_type='bert-base-uncased'):
        ...
        self.criterion = HingeLoss(margin=0.6, l1_norm_weight=0.1, pos_prior_weight=1e-3, neg_prior_weight=1e-3, similarity_mode=similarity_mode)
